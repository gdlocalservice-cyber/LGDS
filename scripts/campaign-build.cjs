...
for (const page of campaigns) {
  const localNav = '<nav class="ads-local-nav" aria-label="On this page"><a href="#problems-heading">Repairs</a><a href="#reviews-heading">Reviews</a><a href="#faq-heading">FAQs</a></nav>';
...
fs.copyFileSync('site/campaign-hero.css',path.join(dir,'lgds-campaign-hero.css'));
...
for(const file of files) {
  ...
  if(ads) $('head').append('<link rel="stylesheet" href="/lgds-campaign-hero.css">');

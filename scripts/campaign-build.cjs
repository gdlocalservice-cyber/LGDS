...
for (const page of campaigns) {
  ...
  const localNav = photoConcept ? '<nav class="ads-local-nav" aria-label="On this page"><a href="#problems-heading">Repairs</a><a href="#reviews-heading">Reviews</a><a href="#faq-heading">FAQs</a></nav>' : '';
